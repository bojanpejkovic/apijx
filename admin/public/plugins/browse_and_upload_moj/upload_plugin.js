(function ( $ ) {
    ...
    $.fn.add_browse = function( options ) {
        ...
        var this_options = {
                    ...
                    file_type: 'image', 
                    file_path: '../slike/upload/', 
                    php_file: url+'/admin/upload_file.php', //php_file: 'upload_file.php',
                    img_thumbnail: true,
                    form_width: '400px',
                    callbackUploaded: ''
        };
        ...
        newForm.prop({
            ...
            'class' : 'jinx_upload_browse'
        });
        newForm.css('max-width', this_options.form_width);
        if(this_options.label != '')
        	newForm.append(this_options.label);
        ...
        var inputFile = $('<input type="file" name="fileToUpload" required />');
        var inputSubmit = $('<input type="submit" value="UPLOAD" />');
        newForm.append(inputFile);
        ...
        newForm[0].addEventListener('submit', function(event) {
                ...
                xhr.onload = function(oEvent) {
                    ...
                    if (this.status == 200) {
                        ...
                        var folder = $('form[name="'+form_name+'"] input[name="file-path"]').val();
                        ...
                        if(str2 == "image"){   //image
                            ...
                            if(that_options.img_thumbnail == true){
                                $('form[name="'+form_name+'"] .img_thumbnail')
                                    ...
                                    //.prop('src', 'http://metalnestalaze.rs/'+folder+filename); 
                        ...
                        alert("Error " + this.status + " occurred uploading your file.");
                    }
                };
