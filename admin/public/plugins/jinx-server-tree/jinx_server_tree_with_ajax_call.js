(function ( $ ) {
    ...
    $.fn.jinx_server_tree = function(  ) {
    	var data = {};
		data.folder_name = 'img_primer_za_server_tree';
		data.btn_ok_title = 'OK';
		data.plugin_type = 'return_folder_tree';
		userDefined.ajax_call('plugins.php', data, 'html', function(htmlCode){
