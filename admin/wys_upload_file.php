<?php
    ...
    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $file_dest.$target_file)) {
            //if (copy('bau/'.$target_file, $file_dest.$target_file)) {
                echo "The file ". basename( $_FILES["fileToUpload"]["name"]). " has been uploaded to:".$file_dest.$target_file;
                //unlink($target_file);
